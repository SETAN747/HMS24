    ...
    docInfo && (
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div>
            <img
              className="bg-customPrimary w-full sm:max-w-72 rounded-lg"
              src={docInfo.image}
              alt=""
            />
          </div>
          ...
          <div className=" flex-1 border border-gray-400  rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 sm:mt-0">
            ...
            <div className=" flex flex-row  gap-2 text-sm mt-1 text-gray-600">
              <p>
        ...
        <div className="sm:ml-72 sm-pl-4 mt-4  font-medium text-gray-700">
            ...
            {docSlots.length &&
              docSlots[slotIndex].map((item, index) => (
                <p onClick={()=>setSlotTime(item.time)}
                  className={
                    `text-sm font-light flex-shrink-0 px-5 py-2 rounded-full cursor-pointer ${item.time === slotTime ?  'bg-customPrimary text-white' : 'text-gray-400 border border-gray-300' } 
                 ` }
                >
          ...
          <button  onClick={bookAppointment} className="bg-customPrimary text-white text-sm font-light px-14 py-3 rounded-full my-6 ">Book an appointment </button>
        </div>
