...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-4 z-50 px-4">
      <div className="max-w-7xl mx-auto bg-white/70 backdrop-blur-xl shadow-xl rounded-2xl px-6 py-4 flex justify-between items-center">
        <img
          onClick={() => navigate("/")}
          ...
          {token && userData ? (
            <div className="flex items-center gap-2 cursor-pointer  relative">
              ...
              <div className="relative group cursor-pointer flex items-center gap-2">
                ...
                <div
                  className="absolute top-0 right-0 pt-16 z-30 opacity-0 scale-95 
                group-hover:opacity-100 group-hover:scale-100
                transition-all duration-200 ease-out pointer-events-none
                group-hover:pointer-events-auto"
                >
                  <div
                    className="min-w-[200px] bg-white/80 backdrop-blur-xl
